...
from src.pkg.feature_3 import feature_3, write_top_n_heap_to_outfile, exhaust_queue
...
class TestFeature3(TestCase):
    ...
    @mock.patch("src.pkg.feature_3.date_to_datetime", side_effect=ValueError)
    ...
    @mock.patch("src.pkg.feature_3.exhaust_queue")
    @mock.patch("src.pkg.feature_3.date_to_datetime")
